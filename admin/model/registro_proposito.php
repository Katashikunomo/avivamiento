    ...
    if (in_array($extension, $formatos_permitidos)) {
        ...
        if (move_uploaded_file($tmp_img, $fichero_subido)) {
            ...
            if ($bandera) {
                ...
                $query = "INSERT INTO cat_images_page(dt_nombre,tp_image,id_user,id_imagen_glob,dt_date) VALUES('$imagen','$tpimage','$id','$id_img',NOW())";
                $res = $mysqli->query($query);
                header("Location:../proposito.php");
            }
        } 
      ...
      header("Location:../proposito.php?error='dont image'");
    }      
